...
%DIF DEL submitted-index.tex   Sat Mar 15 09:28:22 2025
%DIF ADD index.tex             Sun Mar 16 20:19:00 2025
...
\date{\DIFdelbegin \DIFdel{2024-11-01}\DIFdelend \DIFaddbegin \DIFadd{2025-03-16}\DIFaddend }
...
al., 2020\DIFdelbegin \DIFdel{; VanderPlas }\DIFdelend \DIFaddbegin \DIFadd{), can be calculated using the }\texttt{\DIFadd{vinference}} \DIFadd{R package or
the process described in Vanderplas }\DIFaddend et al. \DIFdelbegin \DIFdel{,
...
several rounds of think-aloud pilot testing \DIFaddbegin \DIFadd{(focus) }\DIFaddend before deploying an
experiment. In support of this assessment, we offer up a cautionary tale
of our own experience: that of \DIFdelbegin \DIFdel{(VanderPlas \& Hofmann , }\DIFdelend \DIFaddbegin \DIFadd{Vanderplas \& Hofmann (}\DIFaddend 2017), where we
...
\DIFadd{Researchers designing a study should carefully consider whether the goal
...
recent Prolific experiment), this can \DIFdelbegin \DIFdel{provide an illusion of control over the deluge of
data }\DIFdelend \DIFaddbegin \DIFadd{improve data monitoring}\DIFaddend , allowing
any issues to be spotted and resolved \DIFdelbegin \DIFdel{relatively }\DIFdelend quickly. If server load is a
...
al., 2012; Robinson, 2022; \DIFdelbegin \DIFdel{VanderPlas }\DIFdelend \DIFaddbegin \DIFadd{Vanderplas }\DIFaddend \& Hofmann, 2017). This approach
also works extremely well for psychometric experiments (\DIFdelbegin \DIFdel{VanderPlas }\DIFdelend \DIFaddbegin \DIFadd{Vanderplas }\DIFaddend \&
...
\DIFaddbegin \bibitem[\citeproctext]{ref-robinsonPerceptionCognitiveImplications}
