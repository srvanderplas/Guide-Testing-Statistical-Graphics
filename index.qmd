...
There are heuristics, rules-of-thumb, and various guidelines\cite{asme-standards-graphics,clevelandShapeParameterTwoVariable1988,allenVisualizingScientificData2016} for creating useful and visually attractive charts, but as scientists, we believe empirical evidence is essential for making correct decisions. 
The best way to establish the efficacy of various design decisions, then, is to test our charts by having them evaluated by people under controlled conditions and gathering appropriate data\cite{clevelandGraphicalPerceptionGraphical1985}. 
...
In this paper, we attempt to distill lessons learned from several different sets of experimental graphics experiments, discussing useful testing methods for statistical graphics, the process of designing a graphical experiment, and analysis of the resulting empirical data. It is our hope that by writing this paper, we will save other researchers some hard lessons in what to do (and what not to do), and thereby lower the barriers that exist for conducting research involving empirical tests of statistical graphics. 
